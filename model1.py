...
class MemN2N(object):
    ...
    def train(self, data):
      ...
      for idx in xrange(N):
        ...
        dout, do, kout,kinc,kin, aspin, C0, att, addedZ, maskedZ, Ogg, Z, P, z, a, loss, self.step = self.sess.run([self.Dout, self.dropped_out, self.A, self.Ain_c, self.Ain, self.ASPin, self.C0, self.U3dim, self.AddedZ, self.masked_Z, self.Og ,self.Z, self.P, self.z,
                                            self.optim,
                                            self.loss,
                                            self.global_step],
                                            feed_dict={
