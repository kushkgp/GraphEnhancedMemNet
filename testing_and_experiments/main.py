...
def main(_):
  ...
  # train_data = pkl.load(open('train_data_restaurant.pkl', 'r'))
  test_data = pkl.load(open('test_data.pkl', 'r'))
  # test_data = pkl.load(open('test_data_extra.pkl', 'r'))
  # test_data = pkl.load(open('test_data_restaurant.pkl', 'r'))

  GraphMemNetData = pkl.load(open('TOTAL_LAT_const.pkl','r'))
  # GraphMemNetData = pkl.load(open('TOTAL_LAT_const_restaurant.pkl','r'))
  print "Dump Loaded!!!"
